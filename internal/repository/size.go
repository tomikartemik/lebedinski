...
func (r *SizeRepository) UpdateSize(sizeID int, updateData map[string]interface{}) error {
	return r.db.Model(&model.Size{}).Where("id = ?", sizeID).Updates(updateData).Error
}
